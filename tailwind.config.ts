  ...
  theme: {
    ...
    extend: {
      ...
      fontSize: {
        ...
        "display-lg": ["2.75rem", { lineHeight: "1.1", letterSpacing: "-0.04em" }],
        "display": ["2.25rem", { lineHeight: "1.15", letterSpacing: "-0.03em" }],
        "display-sm": ["1.75rem", { lineHeight: "1.2", letterSpacing: "-0.025em" }],
        "title": ["1.25rem", { lineHeight: "1.3", letterSpacing: "-0.02em" }],
        "label-lg": ["0.8125rem", { lineHeight: "1.4", letterSpacing: "0.02em" }],
        "label": ["0.6875rem", { lineHeight: "1.3", letterSpacing: "0.06em" }],
        "data": ["1.5rem", { lineHeight: "1.2", letterSpacing: "-0.02em", fontWeight: "700" }],
      },
      colors: {
      ...
      keyframes: {
        ...
        "glow-pulse": {
          ...
          "50%": { boxShadow: "0 0 16px hsl(var(--primary) / 0.25)" },
        },
      },
      animation: {
